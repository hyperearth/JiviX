...
namespace svt {
    namespace vma {
        namespace factory {
#ifdef USE_VULKAN
            svt::core::handle_ref<std::shared_ptr<api::factory::image_t>,core::api::result_t> vma::factory::allocator_t::create_image(
                const std::shared_ptr<api::factory::device_t>& device, 
                const std::vector<uint32_t>& queue_family_indices, 
                const api::image_create_info& create_info, 
                const uintptr_t& info_ptr, 
                const api::image_layout& initial_layout
            ) {
                ...
                return { std::dynamic_pointer_cast<api::factory::image_t>(image), core::api::result_t(0u) };
            };
#endif
        };
    };
