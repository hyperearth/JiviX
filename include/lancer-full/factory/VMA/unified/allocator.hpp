    ...
    namespace vma {
        namespace factory {
            class allocator_t : public api::factory::allocator_t { public: 
                ...
                virtual svt::core::handle_ref<std::shared_ptr<api::factory::buffer_t>,core::api::result_t> create_buffer(const std::shared_ptr<api::factory::device_t>& device = {}, const std::vector<uint32_t>& queue_family_indices = {}, const api::buffer_create_info& create_info = {}, const uintptr_t& info_ptr = 0u) override;
