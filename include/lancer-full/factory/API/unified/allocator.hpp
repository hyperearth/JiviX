    ...
    namespace api {
        namespace factory {
            ...
            class allocator_t : public std::enable_shared_from_this<allocator_t> { public: 
                ...
                virtual std::shared_ptr<image_t>  create_image (const std::shared_ptr<device_t>& device, const std::vector<uint32_t>& queue_family_indices = {}, const  image_create_info& create_info = {}, const uintptr_t& info_ptr = 0u, const image_layout& initial_layout = image_layout::t_undefined);
