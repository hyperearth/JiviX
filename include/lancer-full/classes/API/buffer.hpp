...
#ifdef ENABLE_D3D12
#include "../static/API/d3d12/buffer.hpp"
#include "../static/API/d3d12/device.hpp"
#else
#include "../static/API/vulkan/buffer.hpp"
#include "../static/API/vulkan/device.hpp"
#endif
...
namespace svt {
    ...
    class buffer { 
        ...
        public: 
            ...
            // 
            handle_ref<buffer,result_t> create(const create_info& info = {});
