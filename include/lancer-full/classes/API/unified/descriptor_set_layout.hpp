    ...
    namespace api {
        namespace classes {
            ...
            class descriptor_set_layout { public: 
                descriptor_set_layout(const descriptor_set_layout& descriptor_set_layout) : descriptor_set_layout_t(descriptor_set_layout) {};
                descriptor_set_layout(                             const stu::descriptor_set_layout& descriptor_set_layout_t = {}) : descriptor_set_layout_t(descriptor_set_layout_t) {};
                descriptor_set_layout(const stu::device& device_t, const stu::descriptor_set_layout& descriptor_set_layout_t = {}) : descriptor_set_layout_t(descriptor_set_layout_t), device_t(device_t) {};
            ...
            protected: friend descriptor_set; friend descriptor_set_layout;
                ...
                stu::device device_t = {};
                std::vector<description_binding> bindings_t = {};
            };
