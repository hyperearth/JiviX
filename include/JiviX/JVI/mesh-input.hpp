...
namespace jvi {
    ...
    public: friend Node; friend Renderer; friend MeshBinding;
        ...
        protected: virtual uPTR(MeshInput) construct() {
            ...
            auto modSource = vkh::StreamOutputChange(unModSource, semantics);
        ...
        public: virtual uPTR(MeshInput) createRasterizePipeline() {
            ...
            this->transformSetLayoutHelper.pushBinding(vkh::VkDescriptorSetLayoutBinding{ .binding = 3u, .descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, .descriptorCount = 1u, .stageFlags = stage }, index);
